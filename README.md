...
![](https://github.com/dtsivkovski/csa23/workflows/CI/badge.svg) 
![](https://github.com/dtsivkovski/csa23/workflows/GH-Pages%20Status/badge.svg) 
...
```bash
git clone https://github.com/dtsivkovski/statibara.git
cd statibara
bundle install
...
Please [open an issue](https://github.com/dtsivkovski/statibara/issues/new) first to provide feedback. Pull requests are welcome too.
